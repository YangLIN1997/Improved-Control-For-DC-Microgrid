...
interrupt void  adc_isr(void)
{
	  ...
	  if(u1[1]<1 && u1[1]>0){u1[0]=1.9385*u1[1]+0.9233*e1[0]-0.9163*e1[1];}
	  else{u1[0]=0.9385*u1[1]+0.9233*e1[0]- 0.9163*e1[1];}
	  e1[1]=e1[0];
	  u1[1]=u1[0];
	  if(u1[0]>1){u1[0]=1;}else if(u1[0]<0){u1[0]=0;}
	  ...
	  Vpre2=Vref2;
	  e2[0]=Vref2-volt[1];
	  if(u2[1]<1 && u2[1]>0){u2[0]=1.9385*u2[1]+0.9233*e2[0]-0.9163*e2[1];}
	  else{u2[0]=0.9385*u2[1]+0.9233*e2[0]- 0.9163*e2[1];}
	  e2[1]=e2[0];
	  u2[1]=u2[0];
	  if(u2[0]>1){u2[0]=1;}else if(u2[0]<0){u2[0]=0;}
