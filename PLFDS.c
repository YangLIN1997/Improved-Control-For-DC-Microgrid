...
interrupt void adc_isr(void) {
  ...
  Vref1 = (curr[0] < 1) ? 10 - curr[0] * 0.5 : 10 - (curr[0] - 1) * 1;
  if ((Vref1 - Vpre1) > 0.03 || (Vref1 - Vpre1) < 0.03) {
    Vref1 = (Vref1 - Vpre1) * 0.007 + Vpre1;
  }
  Vpre1 = Vref1;
  e1[0] = Vref1 - volt[0];
  if (u1[1] < 1 && u1[1] > 0) {
  ...
  Vref2 = (curr[1] < 1) ? 10 - curr[1] * 0.5 : 10 - (curr[1] - 1) * 1;
  if ((Vref2 - Vpre2) > 0.03 || (Vref2 - Vpre2) < 0.03) {
    Vref2 = (Vref2 - Vpre2) * 0.007 + Vpre2;
  }
  Vpre2 = Vref2;
  e2[0] = Vref2 - volt[1];
  if (u2[1] < 1 && u2[1] > 0) {
